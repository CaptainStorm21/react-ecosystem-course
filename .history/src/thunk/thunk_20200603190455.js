...
we just created. So dispatch, displayAlert. And then up at the top of our component
 ...
 passed to the thunk. And those are the basics of how thunks work in a React application. Obviously there are much more complex things that we can do with thunks and we'll take a look at that shortly. For now, let's change back this component to the way it was before. So we'll delete this prop, delete this prop, and make it pass onCompletePressed again.
